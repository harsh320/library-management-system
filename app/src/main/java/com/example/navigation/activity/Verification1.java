...
public class Verification1 extends AppCompatActivity {
    ...
    private EditText editTextCode;//The edittext to input the code
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(Verification1.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
                ...
                .addOnCompleteListener(Verification1.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(Verification1.this, MainActivity.class);
