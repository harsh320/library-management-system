...
public class NotificationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.Issuelist);
        textView=view.findViewById(R.id.fine);
        recyclerView.setHasFixedSize(true);
        layoutManager=new LinearLayoutManager(getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        adapter4 = new adapter4(new ArrayList<JSONObject>(), getActivity());
        showdata();
                        ...
                        while (kl.hasNext()) {
                            ...
                            if (child != null) {
                                if(child.optString("email").equalsIgnoreCase(email))
                                {
                                    ...
                                    textView.setText("Your Total Fine : ₹"+child.optString("fine"));
                                }
